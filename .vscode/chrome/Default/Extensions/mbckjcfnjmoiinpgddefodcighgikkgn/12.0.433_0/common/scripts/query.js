          ...
          if (resp.accommodation && resp.accommodation.length > 0) {
              for (var m = 0, n = resp.accommodation.length; m < n; m++) {
                  ...
                  if (accommodation != undefined) {
                      ...
                      if (halfStar){
                          urlStars = ((stars_to_show == 1)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal_half.png") + ")"
                                    :(stars_to_show == 2)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal_half.png") + ")"
                                    :(stars_to_show == 3)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal_half.png") + ")"
                                    :(stars_to_show == 4)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal_half.png") + ")" 
                                    :(stars_to_show == 5)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal_half.png") + ")" 
                                    : "");
                          urlStarsHover = ((stars_to_show == 1)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover_half.png") + ")"
                                    :(stars_to_show == 2)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover_half.png") + ")"
                                    :(stars_to_show == 3)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover_half.png") + ")"
                                    :(stars_to_show == 4)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover_half.png") + ")" 
                                    :(stars_to_show == 5)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover_half.png") + ")" 
                                    : "");
                      }
                      else{
                          urlStars = ((accommodation.stars == 1)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + ")"
                                    :(accommodation.stars == 2)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + ")"
                                    :(accommodation.stars == 3)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + ")"
                                    :(accommodation.stars == 4)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + ")"
                                    :(accommodation.stars == 5)? "url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_normal.png") + ")"
                                    : "");
                          urlStarsHover = ((accommodation.stars == 1)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + ")"
                                    :(accommodation.stars == 2)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + ")"
                                    :(accommodation.stars == 3)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + ")"
                                    :(accommodation.stars == 4)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + ")"
                                    :(accommodation.stars == 5)? "url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + "), url("+ AvastWRC.bs.getLocalImageURL("star_hover.png") + ")"
                                    : "");
                      }
                      var accomDetails = {
                          ...
                          starsBackgroundImg: urlStars,
                          starsBackgroundImgHover: urlStarsHover,
                          hotel: true,
