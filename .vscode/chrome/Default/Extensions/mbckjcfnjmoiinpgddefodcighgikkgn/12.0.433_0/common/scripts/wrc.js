    ...
    _.extend(AvastWRC,
        {
             ...
             */
            onTabRemoved : function(tabId, removeInfo, url_map) {
                ...
                if(removeInfo && removeInfo.isWindowClosing) 
                {
                    ...
                    // If REMOVE_FLAG is true, we have already sent the request
                    if(REMOVE_FLAG)
                    {
                ...
                // Setting request
                var keys = [{ key: "request", value: info }];
                ...
                if(url_map)
                {
                    ...
                    removeInfo.isWindowClosing ? tabClosed.tabUpdated = AvastWRC.gpb.All.EventType.WINDOWCLOSE : tabClosed.tabUpdated = AvastWRC.gpb.All.EventType.TABCLOSE;
    
                    if(info)
                    {
                        AvastWRC.get(tabClosed, function (res) {});
                    }
