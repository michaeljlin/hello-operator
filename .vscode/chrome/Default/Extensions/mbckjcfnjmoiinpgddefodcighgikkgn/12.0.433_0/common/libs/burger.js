(function(_, AvastWRC, EventEmitter) {
	...
	Burger.initGlobalData = function(data, sendAll){
		Burger.GLOBAL.ENV = AvastWRC.getWindowStorage("server") || 0;		
	...
	*/
	...
	Burger.Build = {
		...
		eventMessage : function(cliEvent){
			...
			if (cliEvent.time && eventData.time_zone){
	...
	Burger.Query = {		
		...
		SERVER : {
			...
			1 : "http://analytics-dev.ff.avast.com/receive3",
	...
	var PROTO = AvastWRC.PROTO;
 	_.extend(Burger.GLOBAL, {
		BLOB_EVENTS_INFO : {
			...
			"HEARTBEAT": {firstLevel: 55,secondLevel: 1, thirdLevel: 15, type: 1}, //SPMPClientEvents$ClientEvent 55.1.14
			"AFSRC_MATCHING": {firstLevel: 55,secondLevel: 1, thirdLevel: 16, type: 1}, //SPMPClientEvents$ClientEvent 55.1.14
		...
		Blob : PROTO.Message("Burger.Gpb.Blob",{	
			...
			PickedOffer : PROTO.Message("Burger.Gpb.Blob.PickedOffer",{
				...
				Accommodation: PROTO.Message("Burger.Gpb.Blob.PickedOffer.Accommodation",{
					...
					stars_precise: Burger.Gpb.GPBD.Double(9,PROTO.optional)
				}),
				...
				Query : PROTO.Message("Burger.Gpb.Blob.PickedOffer.Query",{
					price: Burger.Gpb.GPBD.Double(1, PROTO.optional),
					formatted_price: Burger.Gpb.GPBD.string(2, PROTO.optional),
				}),
