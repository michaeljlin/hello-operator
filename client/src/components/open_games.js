                        ...
                        return (
                            ...
                            <li id={index} key={index}>
                                ...
                                <label  className={this.state.displaySize === '20vh' && this.state.whichGameClicked === index ? "switch" : "hide"} style={ gameArray[index].player2.agentName === this.state.playerInfo.agentName ? {top: '-7vh', left: '9vw'} : {pointerEvents: 'none', top: '-7vh', left: '9vw'}}>
                                 ...
                                 <p className={gameArray[index].player1.readyState && gameArray[index].player2.readyState && this.state.displaySize === '20vh' &&  (this.state.playerInfo.agentName === gameArray[index].player1.agentName || gameArray[index].player2.agentName) && this.state.whichGameClicked === index ? 'start' : 'hide'} onClick={() => {this.startButtonClicked(gameArray[index], gameArray[index].gameID)}}>Start Mission</p>;
